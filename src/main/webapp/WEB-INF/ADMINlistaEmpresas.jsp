...
<html lang="en">
    ...
    <body>
        ...
        <main class="main">
            <h1 class="outfit">Empresas</h1>
            <c:forEach var="empresa" items="${empresas}">
                <div class="ad-cont a-i-c">
                    <h3 class="outfit">Nombre: ${empresa.nombre}</h3>
                    <p class="montserrat g-p">Identificador de usuario: ${empresa.id }</p>
                    <a href="/admin/empresas/${empresa.id}" class="btn montserrat mt-05">Detalles</a> <!-- revisar: ${Usuario.id} -->
                </div>
            </c:forEach>
       </main>
       <footer>
