    ...
    <body>
        <header class="head">
            ...
            <ul class="navbar">
                ...
                <li><a class="navlink montserrat" href="/">Empresas</a></li>
                <li><a class="navlink montserrat" href="/">Productos</a></li>
                <li><a class="navlink montserrat" href="/">Clientes</a></li>
                <li><a class="navlink montserrat" href="/">Pedidos</a></li>
                <li><a class="navlink montserrat" href="/">Agregar Empresa</a></li>
                <li><a href="/" class="btn montserrat">Cerrar Sesion</a></li>
            </ul>
        </header>
        <main class="main">
            <h1 class="outfit m-1">${cliente.nombre }${cliente.apellido}</h1>
            <div class="r-cont">
                    <div class="mt-05">
                        <p class="montserrat" >Id Cliente:${cliente.id }</p>
                    </div>
                    <div class="mt-05">
                        <p class="montserrat" >Direccion: ${cliente.direccion }</p>
                    </div>
                    <div class="mt-05">
                        <p class="montserrat" >Correo electronico:${cliente.email }</p>
                    </div>
                    <button type="submit" class="btn montserrat mt-05">
                        <span href="/editarInformacionCliente/${cliente.id }"> Editar Cliente </span>
                    </button>
             </div>
        </main>
        <footer>
